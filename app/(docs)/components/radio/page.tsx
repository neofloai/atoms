...
import { data } from '@/src/components/Radio/Radio.examples';
import { RadioShowcase } from './_components/RadioShowcase';
      ...
      <Stack spacing={6}>
        <Stack spacing={1}>
          ...
          <Typography variant="body1" color="text.secondary">
            ...
            <code>{`import { Radio, RadioGroup } from '@neofloai/atoms';`}</code>
          </Typography>
          {data.figmaUrl && (
            <Link
              href={data.figmaUrl}
