...
import { data } from '@/src/components/Avatar/Avatar.examples';
import { AvatarShowcase } from './_components/AvatarShowcase';
      ...
      <Stack spacing={6}>
        <Stack spacing={1}>
          ...
          <Typography variant="body1" color="text.secondary">
            ...
            <code>{`import { Avatar } from '@neofloai/atoms';`}</code>
          </Typography>
          {data.figmaUrl && (
            <Link
              href={data.figmaUrl}
