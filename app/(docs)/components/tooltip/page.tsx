...
import { data } from '@/src/components/Tooltip/Tooltip.examples';
import { TooltipShowcase } from './_components/TooltipShowcase';
      ...
      <Stack spacing={6}>
        <Stack spacing={1}>
          ...
          <Typography variant="body1" color="text.secondary">
            ...
            <code>{`import { Tooltip } from '@neofloai/atoms';`}</code>
          </Typography>
          {data.figmaUrl && (
            <Link
              href={data.figmaUrl}
