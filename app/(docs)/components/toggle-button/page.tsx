...
import { data } from '@/src/components/ToggleButton/ToggleButton.examples';
import { ToggleButtonShowcase } from './_components/ToggleButtonShowcase';

export const metadata = {
  title: 'ToggleButton — Atoms',
