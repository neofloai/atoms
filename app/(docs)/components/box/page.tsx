    ...
    <Container maxWidth="lg" disableGutters>
      <Stack spacing={6}>
        ...
        <Stack spacing={2} sx={{ maxWidth: PROSE }}>
          ...
          <Typography variant="body2" color="text.secondary">
            Box is currently the only layout primitive Atoms exports. MUI&apos;s
            usage-specific containers — Stack for one-dimensional layouts,
            Container for page width, Paper for elevated surfaces — are not
            re-exported yet.
          </Typography>
        </Stack>
