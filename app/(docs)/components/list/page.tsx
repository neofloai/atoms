...
import { data } from '@/src/components/List/List.examples';
      ...
      <Stack spacing={6}>
        ...
        <Stack spacing={3}>
          ...
          <Typography variant="body2" color="text.secondary">
            One flat table across all six parts. Props belonging to a part
            other than <code>List</code> are prefixed with the component that
            owns them. Everything else MUI documents for these components still
            works.
          </Typography>
          <TableContainer
            component={Paper}
