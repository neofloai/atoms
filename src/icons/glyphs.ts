 ...
 * That is ~9,000 icons, about 6 MB, retained by an app that imported
 * `Button` and no icon at all. It is invisible in review: the published
 * `dist/index.mjs` is only 250 KB, because Phosphor is external and the
 * weight only materialises once a consumer resolves it.
 *
