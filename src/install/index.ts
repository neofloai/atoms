...
export const installation: InstallationGuide = {
  ...
  notes: [
    ...
    'Brand fonts (DM Sans, DM Mono and Instrument Serif) are self-hosted and loaded automatically by NeofloThemeProvider -- you do not need to add Google Fonts links or next/font wiring.',
