...
export const data: ComponentExamplesData = {
  ...
  props: [
    ...
    },
    {
      ...
      default: "'contained'",
      description:
        'Visual emphasis: solid fill, 1px border, or bare glyph. `text` takes the role’s soft fill on hover, focus and press — the same states, and the same fills, as `Button`’s `text`.',
    },
    {
      name: 'size',
      type: "'sm' | 'md' | 'lg'",
