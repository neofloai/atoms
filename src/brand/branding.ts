...
export const branding: BrandGuide = {
  ...
  sections: [
    ...
    },
    {
      ...
      summary:
        'Product UI uses Plus Jakarta Sans (with Instrument Serif accents); marketing uses Clash Grotesk. Weights: 400 / 500 / 700.',
      body: [
        'Neoflo runs a two-context type system:',
        '',
        '- Product (the app UI): Plus Jakarta Sans is the primary sans for all interface text; Instrument Serif is an occasional accent for editorial/display moments.',
        '- Marketing: Clash Grotesk is the display face for marketing surfaces, with Instrument Serif as the serif accent.',
        '',
        'Weights are Regular (400), Medium (500), and Bold (700). Plus Jakarta Sans and Instrument Serif are self-hosted by the package (via @fontsource) and load automatically through NeofloThemeProvider — consumers do not wire fonts themselves. Clash Grotesk is not yet self-hosted, so marketing text falls back to Plus Jakarta Sans until it is hosted (see DESIGNER_QUESTIONS.md #7).',
        '',
